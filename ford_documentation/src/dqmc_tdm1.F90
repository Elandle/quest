    ...
    contains
        ...
        subroutine DQMC_TDM1_Meas(T1, tau)
            ...
            blocks: do i0 = 1, tau%nb
                do dtau = 0, tau%nb-1
                    ...
                    if (tau%comp_dn .or. .not.tau%neg_u) call DQMC_Gtau_DumpA(tau, TAU_DN, it, i0)
        ...
        subroutine DQMC_TDM1_Meas_Para(T1, pT1, tau, ptau)
            ...
            do i = 1, tau%nb * tau%nb
                ...
                if (tau%comp_dn .or. .not.tau%neg_u) call DQMC_Gtau_DumpA(ptau(i), TAU_DN, it, i0)          
                jt = ptau(i)%it_up
                j0 = ptau(i)%i0_up
                call DQMC_TDM1_Compute(pT1(i), ptau(i)%upt0, ptau(i)%up0t, ptau(i)%dnt0, ptau(i)%dn0t, ptau(i)%up00, ptau(i)%uptt, ptau(i)%dn00, ptau(i)%dntt, jt, j0)
            ...
            do n = 1, tau%nb * tau%nb
                do iprop = 1, NTDMARRAY
                    do i = 1, T1%properties(iprop)%nclass
                        do it = 0, L-1
                            T1%properties(iprop)%values(i, it, T1%tmp) = T1%properties(iprop)%values(i, it, T1%tmp) + pT1(n)%properties(iprop)%values(i, it, T1%tmp)
                        enddo
                    enddo
                enddo
            enddo
            ...
            if (dt .ne. 0) then
                ...
                do i = 1, T1%properties(ISPXX)%n
                    ...
                    ! k is the distance index of site i and site j
                        ...
                        value1(k) = value1(k) - (up0t(j, i) * dnt0(i, j) + dn0t(j, i) * upt0(i, j)) / 2
                        value2(k) = value2(k) - (up0t(i, j) * dnt0(j, i) + dn0t(i, j) * upt0(j, i)) / 2
                    end do
                end do
                ...
                do i = 1, T1%properties(ISPZZ)%n
                    do j = 1, T1%properties(ISPZZ)%n
                        ...
                        value1(k) = value1(k) - (up0t(j, i) * upt0(i, j) + dn0t(j, i) * dnt0(i, j) - (uptt(i, i) - dntt(i, i)) * (up00(j, j) - dn00(j, j))) * 0.5_wp
                        value2(k) = value2(k) - (dn0t(i, j) * dnt0(j, i) + up0t(i, j) * upt0(j, i) - (uptt(j, j) - dntt(j, j)) * (up00(i, i) - dn00(i, i))) * 0.5_wp
                    end do
                end do
                ...
                do i = 1, T1%properties(IDENS)%n
                    ...
                    value1(k) = value1(k) - (up0t(j, i) * upt0(i, j) + dn0t(j, i) * dnt0(i, j) - (uptt(i, i) + dntt(i, i)) * (up00(j, j) + dn00(j, j)) - 2.0_wp * (1.0_wp - uptt(i, i) - up00(j, j)) - 2.0_wp * (1.0_wp - dntt(i, i) - dn00(j, j))) * 0.5_wp
                    value2(k) = value2(k) - (dn0t(i, j) * dnt0(j, i) + up0t(i, j) * upt0(j, i) - (uptt(j, j) + dntt(j, j)) * (up00(i, i) + dn00(i, i)) - 2.0_wp * (1.0_wp - up00(i, i) - uptt(j, j)) - 2.0_wp * (1.0_wp - dn00(i, i) - dntt(j, j))) * 0.5_wp
                    end do
                end do
                ...
                do i = 1, T1%properties(IPAIR)%n
                    ...
                    ! k is the distance index of site i and site j
                        ...
                        value1(k) = value1(k) + (upt0(i, j) * dnt0(i, j) + dn0t(j, i) * up0t(j, i)) / 2
                        value2(k) = value2(k) + (upt0(j, i) * dnt0(j, i) + dn0t(i, j) * up0t(i, j)) / 2
                    end do
                end do
                        ...
                        if (abs(dxl1)<1.0E-5 .or. abs(dxl2)<1.0E-5) then
                            ...
                            do ic = 0,  T1%properties(ICOND)%nk - 1
                                do jc = 0,  T1%properties(ICOND)%nk - 1
                                    ...
                                    value1(1) = value1(1) - dxl1l2 * tl1up2up * ((uptt(l1e,l1s) - uptt(l1s,l1e)) * (up00(l2e,l2s) - up00(l2s,l2e))) - dxl1l2 * tl1up2dn * ((uptt(l1e,l1s) - uptt(l1s,l1e)) * (dn00(l2e,l2s) - dn00(l2s,l2e))) - dxl1l2 * tl1dn2up * ((dntt(l1e,l1s) - dntt(l1s,l1e)) * (up00(l2e,l2s) - up00(l2s, l2e))) - dxl1l2 * tl1dn2dn * ((dntt(l1e,l1s) - dntt(l1s,l1e)) * (dn00(l2e,l2s) - dn00(l2s,l2e)))
    
                                    ! cross terms
                                    value1(1) = value1(1) + dxl1l2 * tl1up2up * (upt0(l1e,l2s) * up0t(l2e,l1s) + upt0(l1s,l2e) * up0t(l2s,l1e) - upt0(l1e,l2e) * up0t(l2s,l1s) - upt0(l1s,l2s) * up0t(l2e,l1e))
                                    value1(1) = value1(1) + dxl1l2 * tl1dn2dn * (dnt0(l1e,l2s) * dn0t(l2e,l1s) + dnt0(l1s,l2e) * dn0t(l2s,l1e) - dnt0(l1e,l2e) * dn0t(l2s,l1s) - dnt0(l1s,l2s) * dn0t(l2e,l1e))

                                    ! value2: see the rules at the beginning of routine
                                    value2(1) = value2(1) - dxl1l2 * tl1up2up * ((up00(l1e,l1s) - up00(l1s,l1e)) * (uptt(l2e,l2s) - uptt(l2s,l2e))) - dxl1l2 * tl1up2dn * ((up00(l1e,l1s) - up00(l1s,l1e)) * (dntt(l2e,l2s) - dntt(l2s,l2e))) - dxl1l2 * tl1dn2up * ((dn00(l1e,l1s) - dn00(l1s,l1e)) * (uptt(l2e,l2s) - uptt(l2s,l2e))) - dxl1l2 * tl1dn2dn * ((dn00(l1e,l1s) - dn00(l1s,l1e)) * (dntt(l2e,l2s) - dntt(l2s,l2e)))

                                    ! cross terms
                                    value2(1) = value2(1) + dxl1l2 * tl1up2up * (up0t(l1e,l2s) * upt0(l2e,l1s) + up0t(l1s,l2e) * upt0(l2s,l1e) - up0t(l1e,l2e) * upt0(l2s,l1s) - up0t(l1s,l2s) * upt0(l2e,l1e))
                                    value2(1) = value2(1) + dxl1l2 * tl1dn2dn * (dn0t(l1e,l2s) * dnt0(l2e,l1s) + dn0t(l1s,l2e) * dnt0(l2s,l1e) - dn0t(l1e,l2e) * dnt0(l2s,l1s) - dn0t(l1s,l2s) * dnt0(l2e,l1e))
                                end do
                            end do
                        endif
                    end do
                ...
                do i = 1, T1%properties(ISPXX)%n
                    do j = 1, T1%properties(ISPXX)%n
                        ! k is the distance index of site i and site j
                        k = T1%properties(ISPXX)%D(i, j)
                        value1(k) = value1(k) - up0t(j, i) * dnt0(i, j) - dn0t(j, i) * upt0(i, j)
                    end do
                end do
                ...
                do i = 1, T1%properties(ISPZZ)%n
                    do j = 1, T1%properties(ISPZZ)%n
                        ! k is the distance index of site i and site j
                        k = T1%properties(ISPZZ)%D(i, j)
                        value1(k) = value1(k) - (up0t(j, i) * upt0(i, j) + dn0t(j, i) * dnt0(i, j) - (uptt(i, i) - dntt(i, i)) * (up00(j, j) - dn00(j, j)))
                    end do
                end do
                ...
                do i = 1, T1%properties(IDENS)%n
                    do j = 1, T1%properties(IDENS)%n
                        ! k is the distance index of site i and site j
                        k = T1%properties(IDENS)%D(i, j)
                        value1(k) = value1(k) - (up0t(j,i) * upt0(i, j) + dn0t(j, i) * dnt0(i, j) - (uptt(i, i) + dntt(i, i)) * (up00(j, j) + dn00(j, j)) - 2.0_wp * (1.0_wp - uptt(i, i) - up00(j, j)) - 2.0_wp * (1.0_wp - dntt(i, i) - dn00(j, j)))
                    end do
                end do
                ...
                do i = 1, T1%properties(IPAIR)%n
                    do j = 1, T1%properties(IPAIR)%n
                        ! k is the distance index of site i and site j
                        k = T1%properties(IPAIR)%D(i, j)
                        value1(k) = value1(k) + upt0(i, j) * dnt0(i, j) + dn0t(j, i) * up0t(j, i)
                    end do
                end do
        ...
        subroutine DQMC_TDM1_GetErr(T1)
            ...
            if (nproc .eq. 1) then
                data = T1%sgn(1:n)
                call DQMC_JackKnife(n, T1%sgn(avg), T1%sgn(err), data , y, sgn, sum_sgn)
                do iprop = 1, NTDMARRAY
                    do i = 1, T1%properties(iprop)%nClass
                        do j = 0, T1%L-1
            ...
            do h = 1, 3
                ...
                do k = 1, nk
                    ...
                    do m = 0, T1%nbin-1
                        ...
                        if (qmc_sim%size .eq. 1) errSE = errSE + cmplx((real(binSE-avgSE))**2, (aimag(binSE-avgSE))**2)
                    enddo 
