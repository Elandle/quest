    ...
    contains
        ...
        subroutine DQMC_CCS_Compress(n, nnz, A, sparA)
            ...
            if (k .ne. sparA%nnz+1) then
                print *, k, sparA%nnz+1
                call DQMC_Error("The passing in nnz does not match actual number of nonzeros", 0)
            end if
        ...
        subroutine DQMC_Geom_Read_Def(S, gfile, tableFormat)
                            ...
                            select case(idx)
                                ...
                                case(GEMO_B     ) ! n*n
                                    if (def_n) then
                                        ...
                                        call DQMC_Error("nSite need be defined before Bond", 0)
                                    end if
                                ...
                                case(GEMO_D     ) ! n*n    
                                    if (def_n) then
                                        ...
                                        call DQMC_Error("nSite need be defined before D-class", 0)
                                    end if
                                ...
                                case(GEMO_FT    ) ! nclass*nclass   
                                    if (def_c) then
                                        ...
                                        call DQMC_Error("nClass need be defined before Fourier Trans", 0)
                                    end if
                                ...
                                case(GEMO_T     ) ! n*n
                                    if (def_n) then
                                        ...
                                        call DQMC_Error("nSite need be defined before Hopping", 0)
                                    end if
                                ...
                                case(GEMO_W     ) ! n_b*nwave
                                    if (def_w .and. def_b) then
                                        ...
                                        call DQMC_Error("n_b and nWave need be defined before Wave funs", 0)
                                    end if
            ...
            if (S%checklist(STRUCT_PHASE)) then
                if (size(S%P) .ne. S%nSite) then
                    call DQMC_Error("The length of phase assignment is not equal to nSite", 0)
                end if
            end if
